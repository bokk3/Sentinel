...
From a Game Theoretic perspective, this principle serves as a \textit{Costly Signal}. By hard-coding the willingness to sacrifice material assets to avoid civilian harm, the defender signals a credible commitment to Limited War. This reduces the security dilemma—the adversary knows that the Sentinel will not escalate indiscriminately. In an era of automated flash-wars, such dampening signals may be the only mechanism to prevent an accidental slide into total conflict.
