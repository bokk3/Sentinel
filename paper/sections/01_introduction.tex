...
\subsection{Roadmap}
The remainder of this paper is structured as follows. Section \ref{sec:litreview} reviews the existing literature, highlighting the inadequacies of Asimov’s original laws and the current debates within Just War Theory. Section \ref{sec:framework} introduces the core contribution of this work: the ``Sentinel'' Ruleset, a five-principle hierarchy designed to operationalize defensive ethics. Section \ref{sec:analysis} stress-tests this ruleset against complex scenarios, including the ``Hypersonic Dilemma'' and ``Broken Arrow'' incidents. Section \ref{sec:discussion} explores the broader implications, including the ``Blackstone's Ratio'' of AI, the paradox of pre-delegation, and adversarial vulnerabilities. Finally, Section \ref{sec:conclusion} outlines the path toward technical implementation and international standardization.
